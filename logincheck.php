...
$_SESSION['prev'] = $_SESSION['jumpURL'];
?>
...
<html>
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="6u">
                            ...
                            <section>
                                ...
                                <form action="http://www.cise.ufl.edu/~you/logincheck.php" method="post">
                                    <p style="position:relative; left: 40px;">Username:<br/>
                                        <input type="text" name="username" size="60" value="" />
                                    </p>
                                    <p style="position:relative; left: 40px;">Password:<br/>
                                        <input type="password" name="password" size="60" value="" />
                                    </p>
                                    <input style="padding: 0.8px 42px; font-size: 1.5em;" class="button-big" type="submit" name="submit" value="Sign In" />
                                </form>
                        ...
                        <div class="6u">
                            ...
                            <section>
                                ...
                                <form action="http://www.cise.ufl.edu/~you/register.php" method="post">
                                    <p style="position:relative; left: 40px;">Username*:<br/>
                                        <input type="text" name="username" size="60" value="" />
                                    </p>
                                    <p style="position:relative; left: 40px;">Password*:<br/>
                                    ...
                                    <p style="position:relative; left: 40px;">Full Name*:<br/>
                                        <input type="text" name="name" size="60" value="" />
                                    </p>
                                    <input style="padding: 0.8px 42px; font-size: 1.5em;" class="button-big" type="submit" name="submit" value="Create Account" />
                                </form>
        ...
        <p>Or <a href="http://www.cise.ufl.edu/~you/register.php">Register</a>!</p>
        <script>
            alert("<?php
                            $entername = $_POST['username'];
                            ...
                            $q_check = "select * from Muser where username='$entername' and password='$enterpass'";
                            $statement = oci_parse($connection, $q_check);

                            oci_execute($statement);
                            $result = oci_fetch_array($statement, OCI_BOTH);
                            if ($result) {
                                //oci_fetch_object($statement); //= oci_result($statement);//, 'USER_ID') . "|" . oci_result($statement, 'USERNAME');
        ...
        <?php
        if ($result) {
            echo "<meta http-equiv=refresh content=0.1;URL=http://www.cise.ufl.edu/~you/log_in_session.php?userid=$result[0]>";
        }
        ?>
    </body>
</html>
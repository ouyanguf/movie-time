                        ...
                        <div class="12u">
                            ...
                            <section>
                                ...
                                <p>
                                    ...
                                    $q1 = "select *
                                      from $table
                                      where lower($attr) = lower('$content')
                                      order by $attr";
                                    ...
                                    if (!oci_fetch_object($st1)) {
                                      ...
                                      ";
                                                $i = 1;
                                                while (oci_fetch_object($st1) and $i <= 100) {
                                                    $id = oci_result($st1, 'MOVIE_ID');
                                                    $t = oci_result($st1, 'TITLE');
                                                    $p = oci_result($st1, 'PRICE');
                                                    $inv = oci_result($st1, 'INVENTORY');

                                                    echo "
                                      <tr>
                                      <td>$i</td>
                                      <td><a href =/~you/display.php?MOVIE_ID=$id>$id</a></td>
                                      <form action=update_admin.php?table=$table&id=$id method=post>
                                      <td><input type=text name=TITLE size=10 value=$t /></td>
                                      <td><input type=text name=PRICE size=10 value=$p /></td>
                                      <td><input type=text name=INVENTORY size=10 value=$inv /></td>
                                      <td><input type=submit name=submit value=UPDATE /></td>
                                      </form>
                                      <form action=delete.php?table=$table&id=$id method=post>
                                      ...
                                      ";
                                                $i = 1;
                                                while (oci_fetch_object($st1) and $i <= 100) {
                                                    $id = oci_result($st1, 'USER_ID');
                                                    $un = oci_result($st1, 'USERNAME');
                                                    $pa = oci_result($st1, 'PASSWORD');
                                                    $na = oci_result($st1, 'NAME');
                                                    echo "
                                      <tr>
                                      <td>$i</td>
                                      <td><a href =/~you/UserProfile.php?USER_ID=$id>$id</a></td>
                                      <form action=update_admin.php?table=$table&id=$id method=post>
                                      <td><input type=text name=username size=10 value=$un /></td>
                                      <td><input type=text name=password size=10 value=$pa /></td>
                                      <td><input type=text name=name size=10 value=$na /></td>
                                      <td><input type=submit name=submit value=UPDATE /></td>
                                      </form>
                                      <form action=delete.php?table=$table&id=$id method=post>
                                      <td><input type=submit name=submit value=DELETE /></td>

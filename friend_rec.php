            ...
            <div id="content">
                <div class="5grid-layout">
                    <div class="row">
                        ...
                        <tr>
                        <th>Rank</th>
                        <th width=35 align=center>New Friend</th>
                        <th align=center>Old Friend Count</th>
                        </tr>
                        ";
                                $i = 1;
                        ...
                        <td><a href=/~you/frienddisplay.php?USER_ID=$send1>$n1</a></td>
                        ...
                        <div class="4u">
                            ...
                            <section>
                                ...
                                while (oci_fetch_object($st2) and $ib <= 10) {
                                  ...
                                  <td><a href=/~you/frienddisplay.php?USER_ID=$send2>$n2</a></td>
...
//Recommendation By No. of Same Preference Genre
                        ...
                        <th width=35 align=center>Rank</th>
                        <th align=center>New Friend</th>
                        <th align=right>No. Of Same Genres</th>
                        </tr>
                        ";
                                $i_income = 1;
                                while (oci_fetch_object($st3) and $i_income <= 15) {
                        ...
                        <td><a href=/~you/frienddisplay.php?USER_ID=$send3>$n3</a></td>

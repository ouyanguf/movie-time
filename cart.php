                        ...
                        <div class="9u">
                            ...
                            <section>
                                <section>
                                    ...
                                    <input style="position:relative; left:610px; padding: 2px 42px; font-size: 1.3em;" class="button-big" type = "submit" value = "UPDATE" style = "border-width:3px" size="15">
                                    </form>	
                                </section>
...
?>									
                                    ...
                                    <li>
                                        <form action="http://www.cise.ufl.edu/~you/order.php" method="post" >  </br>

                                            <input style="padding: 2px 32px; font-size: 1.2em;" class="button-big" type="submit"; value="PROCESS TO CHECK OUT" style="border-width:3px">
